            ...
            <div class="modal-content">
                <form action="{{ route('mk.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <select id="skema-select-jurusan" name="skema_ids[]" multiple placeholder="Pilih satu atau lebih skema..." autocomplete="off">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const skemaSelect = document.querySelector('#skema-select-jurusan');
