<x-app-layout>
    ...
    <div class="container-xl p-2">
        ...
        <div class="d-flex flex-wrap gap-2 mb-3">
            ...
            <a href="{{ route('asesor.create') }}" class="inline-flex items-center gap-x-2 bg-indigo-600 hover:bg-indigo-700 btn btn-sm btn-outline-primary my-2">
            ...
            <a href="{{ route('asesor.template') }}" class="inline-flex items-center gap-x-2 bg-indigo-600 hover:bg-indigo-700 btn btn-sm btn-outline-success my-2">
