                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center p-1">
                                                @if ($hasFile)
                                                <input type="checkbox"
                                                    class="form-check-input m-0 check-target-{{ $cpmk->id }}"
                                            ...
                                            <td class="text-center bg-light">
                                                @if ($hasFile)
                                                <input type="checkbox" class="form-check-input check-row" data-id="{{ $cpmk->id }}">
                                                @endif
                                            </td>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function initCheckAll() {
                document.querySelectorAll('.check-row').forEach(master => {
                    ...
                    // Jika jumlah yang tercentang sama dengan total item, centang master-nya
